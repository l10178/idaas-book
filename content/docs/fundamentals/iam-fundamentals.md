...
description: "IAM 完整入门指南：AAA 认证授权审计模型、数字身份类型、IAM 与 IDaaS 区别、最小权限与纵深防御等核心设计原则"
...
| 客户身份 | 终端用户 | 大规模，CIAM 场景。详见 [CIAM vs Workforce IAM]({{< relref "docs/advanced-topics/iam-vs-ciam-workforce.md" >}}) |
...
> **延伸**：认证通过后，如何管理会话的生命周期？见 [IAM 会话管理与 Token 生命周期]({{< relref "../advanced-topics/iam-session-management" >}})——SSO 会话架构、Token 刷新与吊销。
