...
description: "主流 IDaaS 方案全景对比：开源 vs 商业、自建 vs SaaS，Keycloak、Casdoor、Zitadel、Ory、Dex、CAS 等方案选型决策框架"
...
> 📖 **扩展阅读**：[开源 IAM 对比与选型指南]({{< relref "docs/advanced-topics/opensource-iam-comparison.md" >}}) 提供了更详细的决策树、场景推荐和功能对比矩阵——如果你在多个开源方案之间犹豫，建议先看那篇再做决定。
