...
description: "DID、可验证凭证与区块链身份技术详解：探索去中心化身份如何从根本上改变 IDaaS 的信任模型与数据主权"
...
> 去中心化身份与「身份即控制平面」的理念相呼应——无论身份载体如何演进，它都是零信任架构的基石。相关内容见[第24章：零信任与身份驱动安全]({{< relref "docs/advanced-topics/zero-trust-identity.md" >}})。
